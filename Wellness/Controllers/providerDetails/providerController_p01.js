...
providerp01App.directive('videoArtDir', function($sce){
	return{
		restrict:"A",
		replace:true,
		link:function(scope, element, attrs){
			scope.videoSce = $sce.trustAsResourceUrl(attrs.videourl);
			scope.artImgSce = $sce.trustAsResourceUrl(attrs.artimageurl);
		}//End link function
...
providerp01App.directive('changeColor', function(){
	return{
		...
		link:function(scope, element, attrs){
				...
				scope.ratingNum = Number(attrs.rating); //console.log(scope.ratingNum);
