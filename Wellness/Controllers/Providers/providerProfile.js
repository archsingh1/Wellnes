...
providerProfile.controller('detailsController', function($scope, $http, $window, providerProfileFactory){
	...
	$scope.hideEduBtn = true; //hide the add a College button
	$scope.hideExpBtn = true; //hide the add a Work Experience button
	...
	return{
		...
		controller:function($scope){
			...
			$scope.eduSec = function(){
				...
				$scope.hideEduBtn  = !($scope.hideEduBtn);
			}
			...
			$scope.expSec = function(){
				...
				$scope.hideExpBtn  = !($scope.hideExpBtn);
			}
