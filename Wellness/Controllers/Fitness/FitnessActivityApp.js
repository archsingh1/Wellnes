var FitnessActivityApp = angular.module('FitnessActivityApp', ['fitnessProviderFactory', 'lazyLoadApp', 'hideImgDir',  'changeColorDir']);

FitnessActivityApp.controller('FitActController', function($scope, fpFactory, $routeParams, $http){
