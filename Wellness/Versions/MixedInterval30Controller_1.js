var mixedInterval30App = angular.module('mixedInterval30App', []);

mixedInterval30App.factory('MI30Factory', function($http){
	var MI30Factory={} ;
	
	MI30Factory.getData = function(){
...
mixedInterval30App.controller('MI30Controller', function($scope, MI30Factory){
	MI30Factory.getData().success(function(data){
		$scope.providers = [] ;
