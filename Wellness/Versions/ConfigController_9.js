var configApp = angular.module('configApp', ['ngRoute', 'nutritionApp', 'mindfulApp', 'providerApp',	'providerp01App', 'fitnessApp', 'mixedInterval30App', 'goodDayStartApp', 	'goalSettingApp', 'f15App', 'U01_Alex']);
		...
		.when('/f15',
			{
				...
				templateUrl:'FitnessPages/Providers/f15_Catherine.html'
			}
		...
		.when('/userLogin',
			{
				...
				templateUrl:'UserPages/User/U01_Alex.html'
			}
